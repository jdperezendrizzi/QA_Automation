...
class TCFacturacion (unittest.TestCase):
    ...
    # @unittest.skip("Not needed now")
    def test_facturacion_debito_automatico(self):
        # Login
        ...
        self.page_facturacion.completar_documento("34922840")
        self.page_facturacion.seleccionar_tarjeta_por_indice(1)
        time.sleep(10)
        self.page_facturacion.seleccionar_tipo_tarjeta_por_indice(0)
